...
#         dz_tf = tf.multiply(dx, dz_tf)
    ...
    if params['coefficient_initialization'] == 'xavier':
        ...
        sindy_coefficients = tf.get_variable('sindy_coefficients', shape=[library_dim,latent_dim], initializer=tf.initializers.random_normal(mean=0.0, stddev=0.1, seed=10))
